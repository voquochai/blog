...
<div class="row">
	<div class="col-12">
		<div class="card">
            ...
            <div class="card-body">
                <form method="post" action="<?php echo e(route('admin.users.update', ['id'=>$user->id, 'type'=>'mod'])); ?>">
                    <?php echo method_field('PUT'); ?>
                    <?php echo csrf_field(); ?>
                    <div class="form-group mb-3">
                        <label>Họ và tên</label>
                        <input type="text" name="name" class="form-control" placeholder="Họ và tên" value="<?php echo e($user->name); ?>" required="">
                    </div>
                    <div class="form-group mb-3">
                        <label>Email</label>
                    ...
                    <div class="form-group mb-3">
                        <label>Thứ tự</label>
                        <input type="number" name="priority" class="form-control" value="<?php echo e($user->priority); ?>" min="1" max="9999" placeholder="Thứ tự" disabled>
                    </div>
                    <div class="form-group mb-3">
                        ...
                        <div class="custom-control custom-control-inline custom-checkbox ml-2">
                            <input type="checkbox" name="status[]" value="<?php echo e($k); ?>" <?php echo e(strpos($user->status,$k) !== false ? 'checked' : ''); ?> class="custom-control-input" id="customCheck<?php echo e($k); ?>">
                    ...
                    <a href="<?php echo e(route('admin.users.index', ['type'=>$type])); ?>" class="btn btn-danger" > <i class="mdi mdi-close"></i> Thoát</a>
                </form>
