...
<div class="row">
    <div class="col-12">
        <div class="card">
            ...
            <div class="card-body">
                <form method="post" action="<?php echo e(route('admin.suppliers.update', ['id'=>$item->id, 'type'=>$type])); ?>" class="form-validation" novalidate="">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-10 col-12">
                            <input type="text" name="code" class="form-control validate[required]" placeholder="Mã nhà cung cấp" value="<?php echo e($item->code); ?>">
                        </div>
                    </div>
                    <div class="form-group row">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-10 col-12">
                            <input type="text" name="phone" class="form-control" placeholder="Số điện thoại" value="<?php echo e($item->phone); ?>">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-form-label col-lg-2 col-12">Địa chỉ</label>
                        <div class="col-lg-10 col-12">
                            <input type="text" name="address" class="form-control" placeholder="Địa chỉ" value="<?php echo e($item->address); ?>">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-form-label col-lg-2 col-12">Mô tả</label>
                        <div class="col-lg-10 col-12">
                            <textarea name="description" rows="5" class="form-control" placeholder="Mô tả"><?php echo e($item->description); ?></textarea>
                        </div>
                    </div>
                    <div class="form-group row">
