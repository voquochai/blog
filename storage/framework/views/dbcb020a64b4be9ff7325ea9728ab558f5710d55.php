		...
		<div class="card">
			<div class="card-header">
                <div class="card-widgets">
                    <a href="<?php echo e(route('admin.products.create', ['type'=>$type])); ?>" class="btn btn-primary mr-2"> <i class="mdi mdi-plus"></i> Tạo mới</a>
                    <div class="dropdown">
                    ...
                    <table class="table table-centered">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="<?php echo e(route('admin.products.edit', ['id'=>$item->id, 'type'=>$type])); ?>" class="btn btn-sm btn-primary">
